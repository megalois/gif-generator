...
parser = argparse.ArgumentParser(description='GIF Generator. '
...
parser.add_argument('--loop',
                    type=int, 
                    help='The number of times the GIF should loop. Do not set or set to 0 for infinite.')                                        
